// Export pages
export '/user_selection/budget_page/budget_page_widget.dart'
    show BudgetPageWidget;
export '/pages/welcome/welcome_widget.dart' show WelcomeWidget;
export '/user_selection/preferences_page/preferences_page_widget.dart'
...
export '/user_selection/scope_page/scope_page_widget.dart' show ScopePageWidget;
export '/user_selection/people_page/people_page_widget.dart'
    show PeoplePageWidget;
...
export '/edit_itinerary/edit_itinerary_widget.dart' show EditItineraryWidget;
export '/place_detail/place_detail_widget.dart' show PlaceDetailWidget;
export '/top10/top10_widget.dart' show Top10Widget;
export '/top5/top5_widget.dart' show Top5Widget;
