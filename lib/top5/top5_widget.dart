...
import 'top5_model.dart';
export 'top5_model.dart';

class Top5Widget extends StatefulWidget {
  const Top5Widget({super.key});
...
class _Top5WidgetState extends State<Top5Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Top5Model());
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    'Carnaval & Coastline: A Rio Adventure',
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(10.0),
                                  child: Text(
                                    'Samba, Sunsets, and Scenic Views',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(10.0),
                                  child: Text(
                                    'The Ultimate Rio Experience: Beaches, Beats, and Beyond\"',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Inter',
