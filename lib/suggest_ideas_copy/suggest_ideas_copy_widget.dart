...
import 'suggest_ideas_copy_model.dart';
export 'suggest_ideas_copy_model.dart';

class SuggestIdeasCopyWidget extends StatefulWidget {
  const SuggestIdeasCopyWidget({super.key});

  @override
  State<SuggestIdeasCopyWidget> createState() => _SuggestIdeasCopyWidgetState();
}

class _SuggestIdeasCopyWidgetState extends State<SuggestIdeasCopyWidget> {
  late SuggestIdeasCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuggestIdeasCopyModel());
